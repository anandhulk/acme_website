...
/* harmony export */ });
/* harmony import */ var _Cloneable_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Cloneable.js */ "./iab-tcf-core/Cloneable.js");
/* harmony import */ var _errors_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./errors/index.js */ "./iab-tcf-core/errors/index.js");
/* harmony import */ var _Json_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Json.js */ "./iab-tcf-core/Json.js");
/* harmony import */ var _model_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./model/index.js */ "./iab-tcf-core/model/index.js");
...
class GVL extends _Cloneable_js__WEBPACK_IMPORTED_MODULE_0__.Cloneable {
  ...
  mapGoogleVendors(vendorIds) {
    if (!Array.isArray(vendorIds)) {
      vendorIds = Object.keys(this.fullGoogleVendorList).map(vId => +vId);
    }
...
/* harmony import */ var _Cloneable_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Cloneable.js */ "./iab-tcf-core/Cloneable.js");
/* harmony import */ var _errors_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./errors/index.js */ "./iab-tcf-core/errors/index.js");
/* harmony import */ var _GVL_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./GVL.js */ "./iab-tcf-core/GVL.js");
/* harmony import */ var _model_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./model/index.js */ "./iab-tcf-core/model/index.js");
...
/* harmony export */ });
/* harmony import */ var _encoder_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./encoder/index.js */ "./iab-tcf-core/encoder/index.js");
/* harmony import */ var _model_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model/index.js */ "./iab-tcf-core/model/index.js");
/* harmony import */ var _encoder_field_IntEncoder_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./encoder/field/IntEncoder.js */ "./iab-tcf-core/encoder/field/IntEncoder.js");
/* harmony import */ var _TCModel_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./TCModel.js */ "./iab-tcf-core/TCModel.js");
...
/* harmony export */ });
/* harmony import */ var _errors_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../errors/index.js */ "./iab-tcf-core/errors/index.js");
...
/* harmony export */ });
/* harmony import */ var _model_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/index.js */ "./iab-tcf-core/model/index.js");
...
/* harmony export */ });
/* harmony import */ var _Base64Url_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Base64Url.js */ "./iab-tcf-core/encoder/Base64Url.js");
/* harmony import */ var _BitLength_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BitLength.js */ "./iab-tcf-core/encoder/BitLength.js");
/* harmony import */ var _field_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./field/index.js */ "./iab-tcf-core/encoder/field/index.js");
/* harmony import */ var _sequence_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sequence/index.js */ "./iab-tcf-core/encoder/sequence/index.js");
/* harmony import */ var _errors_index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../errors/index.js */ "./iab-tcf-core/errors/index.js");
/* harmony import */ var _model_Fields_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../model/Fields.js */ "./iab-tcf-core/model/Fields.js");
/* harmony import */ var _model_index_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../model/index.js */ "./iab-tcf-core/model/index.js");
              ...
              if (tcModel.isServiceSpecific) {
                if (vendor.flexiblePurposes.length === 0) {
                  ...
                  for (let i = 0, len = restrictions.length; i < len && !isValid; i++) {
                     ...
                     */
                    isValid = restrictions[i].restrictionType === _model_index_js__WEBPACK_IMPORTED_MODULE_1__.RestrictionType.REQUIRE_CONSENT && gvlVendorKey === 'purposes' || restrictions[i].restrictionType === _model_index_js__WEBPACK_IMPORTED_MODULE_1__.RestrictionType.REQUIRE_LI && gvlVendorKey === 'legIntPurposes';
                  }
...
/* harmony export */ });
/* harmony import */ var _IntEncoder_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./IntEncoder.js */ "./iab-tcf-core/encoder/field/IntEncoder.js");
/* harmony import */ var _errors_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../errors/index.js */ "./iab-tcf-core/errors/index.js");
...
/* harmony export */ });
/* harmony import */ var _model_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../model/index.js */ "./iab-tcf-core/model/index.js");
/* harmony import */ var _BooleanEncoder_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BooleanEncoder.js */ "./iab-tcf-core/encoder/field/BooleanEncoder.js");
/* harmony import */ var _DateEncoder_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DateEncoder.js */ "./iab-tcf-core/encoder/field/DateEncoder.js");
/* harmony import */ var _FixedVectorEncoder_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./FixedVectorEncoder.js */ "./iab-tcf-core/encoder/field/FixedVectorEncoder.js");
/* harmony import */ var _IntEncoder_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./IntEncoder.js */ "./iab-tcf-core/encoder/field/IntEncoder.js");
/* harmony import */ var _LangEncoder_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./LangEncoder.js */ "./iab-tcf-core/encoder/field/LangEncoder.js");
/* harmony import */ var _PurposeRestrictionVectorEncoder_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./PurposeRestrictionVectorEncoder.js */ "./iab-tcf-core/encoder/field/PurposeRestrictionVectorEncoder.js");
/* harmony import */ var _VendorVectorEncoder_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./VendorVectorEncoder.js */ "./iab-tcf-core/encoder/field/VendorVectorEncoder.js");
...
/* harmony export */ });
/* harmony import */ var _BooleanEncoder_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BooleanEncoder.js */ "./iab-tcf-core/encoder/field/BooleanEncoder.js");
/* harmony import */ var _errors_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../errors/index.js */ "./iab-tcf-core/errors/index.js");
/* harmony import */ var _model_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../model/index.js */ "./iab-tcf-core/model/index.js");
...
/* harmony export */ });
/* harmony import */ var _BitLength_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../BitLength.js */ "./iab-tcf-core/encoder/BitLength.js");
/* harmony import */ var _BooleanEncoder_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BooleanEncoder.js */ "./iab-tcf-core/encoder/field/BooleanEncoder.js");
/* harmony import */ var _errors_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../errors/index.js */ "./iab-tcf-core/errors/index.js");
/* harmony import */ var _IntEncoder_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./IntEncoder.js */ "./iab-tcf-core/encoder/field/IntEncoder.js");
/* harmony import */ var _model_index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../model/index.js */ "./iab-tcf-core/model/index.js");
...
class PurposeRestrictionVectorEncoder {
  static encode(prVector) {
    ...
    let bitString = _IntEncoder_js__WEBPACK_IMPORTED_MODULE_3__.IntEncoder.encode(prVector.numRestrictions, _BitLength_js__WEBPACK_IMPORTED_MODULE_0__.BitLength.numRestrictions); // if the vector is empty we'll just return a string with just the numRestricitons being 0
    ...
    if (!prVector.isEmpty()) {
      ...
      prVector.getRestrictions().forEach(purpRestriction => {
        ...
        bitString += _IntEncoder_js__WEBPACK_IMPORTED_MODULE_3__.IntEncoder.encode(purpRestriction.restrictionType, _BitLength_js__WEBPACK_IMPORTED_MODULE_0__.BitLength.restrictionType); // now get all the vendors under that restriction
  ...
  static decode(encodedString) {
    ...
    for (let i = 0; i < numRestrictions; i++) {
      ...
      index += _BitLength_js__WEBPACK_IMPORTED_MODULE_0__.BitLength.purposeId; // Second Restriction Type
      ...
      const purposeRestriction = new _model_index_js__WEBPACK_IMPORTED_MODULE_4__.PurposeRestriction(purposeId, restrictionType); // Num Entries (number of vendors)
...
/* harmony export */ });
/* harmony import */ var _model_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../model/index.js */ "./iab-tcf-core/model/index.js");
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../index.js */ "./iab-tcf-core/encoder/index.js");
/* harmony import */ var _IntEncoder_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./IntEncoder.js */ "./iab-tcf-core/encoder/field/IntEncoder.js");
/* harmony import */ var _BooleanEncoder_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./BooleanEncoder.js */ "./iab-tcf-core/encoder/field/BooleanEncoder.js");
/* harmony import */ var _FixedVectorEncoder_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./FixedVectorEncoder.js */ "./iab-tcf-core/encoder/field/FixedVectorEncoder.js");
/* harmony import */ var _VectorEncodingType_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./VectorEncodingType.js */ "./iab-tcf-core/encoder/field/VectorEncodingType.js");
/* harmony import */ var _errors_index_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../errors/index.js */ "./iab-tcf-core/errors/index.js");
...
class VendorVectorEncoder {
  static encode(value) {
    ...
    let retrString = _IntEncoder_js__WEBPACK_IMPORTED_MODULE_2__.IntEncoder.encode(value.maxId, _index_js__WEBPACK_IMPORTED_MODULE_1__.BitLength.maxId); // bit field will be just the vendors as we walk through the vector
    ...
    const minRangeLength = _index_js__WEBPACK_IMPORTED_MODULE_1__.BitLength.vendorId * 2 + _index_js__WEBPACK_IMPORTED_MODULE_1__.BitLength.singleOrRange + _index_js__WEBPACK_IMPORTED_MODULE_1__.BitLength.numEntries; // gets larger as we walk through the vector

    let rangeLength = headerLength + _index_js__WEBPACK_IMPORTED_MODULE_1__.BitLength.numEntries; // walk through every value in the vector
    ...
    value.forEach((curValue, i) => {
      ...
      if (rangeIsSmaller && curValue) {
        ...
        if (!nextValue) {
          ...
          rangeLength += _index_js__WEBPACK_IMPORTED_MODULE_1__.BitLength.vendorId; // store the array in our bigger array
  ...
  static decode(value, version) {
    ...
    if (encodingType === _VectorEncodingType_js__WEBPACK_IMPORTED_MODULE_5__.VectorEncodingType.RANGE) {
      ...
      index += _index_js__WEBPACK_IMPORTED_MODULE_1__.BitLength.numEntries; // loop through each group of entries
      ...
      for (let i = 0; i < numEntries; i++) {
        ...
        index += _index_js__WEBPACK_IMPORTED_MODULE_1__.BitLength.vendorId; // if it's a range, the next set of bits is the second id
        ...
        if (isIdRange) {
          ...
          index += _index_js__WEBPACK_IMPORTED_MODULE_1__.BitLength.vendorId; // we'll need to set or unset all the vendor ids between the first and second
  ...
  static buildRangeEncoding(ranges) {
    ...
    let rangeString = _IntEncoder_js__WEBPACK_IMPORTED_MODULE_2__.IntEncoder.encode(numEntries, _index_js__WEBPACK_IMPORTED_MODULE_1__.BitLength.numEntries); // each range
    ...
    ranges.forEach(range => {
      ...
      rangeString += _BooleanEncoder_js__WEBPACK_IMPORTED_MODULE_3__.BooleanEncoder.encode(!single); // second is the first (or only) vendorId
...
/* harmony export */ });
/* harmony import */ var _BooleanEncoder_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BooleanEncoder.js */ "./iab-tcf-core/encoder/field/BooleanEncoder.js");
/* harmony import */ var _DateEncoder_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DateEncoder.js */ "./iab-tcf-core/encoder/field/DateEncoder.js");
/* harmony import */ var _FieldEncoderMap_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./FieldEncoderMap.js */ "./iab-tcf-core/encoder/field/FieldEncoderMap.js");
/* harmony import */ var _FixedVectorEncoder_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./FixedVectorEncoder.js */ "./iab-tcf-core/encoder/field/FixedVectorEncoder.js");
/* harmony import */ var _IntEncoder_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./IntEncoder.js */ "./iab-tcf-core/encoder/field/IntEncoder.js");
/* harmony import */ var _LangEncoder_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./LangEncoder.js */ "./iab-tcf-core/encoder/field/LangEncoder.js");
/* harmony import */ var _PurposeRestrictionVectorEncoder_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./PurposeRestrictionVectorEncoder.js */ "./iab-tcf-core/encoder/field/PurposeRestrictionVectorEncoder.js");
/* harmony import */ var _VectorEncodingType_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./VectorEncodingType.js */ "./iab-tcf-core/encoder/field/VectorEncodingType.js");
/* harmony import */ var _VendorVectorEncoder_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./VendorVectorEncoder.js */ "./iab-tcf-core/encoder/field/VendorVectorEncoder.js");
...
/* harmony import */ var _Base64Url_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Base64Url.js */ "./iab-tcf-core/encoder/Base64Url.js");
/* harmony import */ var _BitLength_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BitLength.js */ "./iab-tcf-core/encoder/BitLength.js");
/* harmony import */ var _EncodingOptions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./EncodingOptions.js */ "./iab-tcf-core/encoder/EncodingOptions.js");
/* harmony import */ var _SegmentEncoder_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SegmentEncoder.js */ "./iab-tcf-core/encoder/SegmentEncoder.js");
/* harmony import */ var _SemanticPreEncoder_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./SemanticPreEncoder.js */ "./iab-tcf-core/encoder/SemanticPreEncoder.js");
/* harmony import */ var _field_index_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./field/index.js */ "./iab-tcf-core/encoder/field/index.js");
/* harmony import */ var _sequence_index_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sequence/index.js */ "./iab-tcf-core/encoder/sequence/index.js");
...
class FieldSequence {
  ...
  '2' = {
    ...
    [_model_index_js__WEBPACK_IMPORTED_MODULE_0__.Segment.PUBLISHER_TC]: [_model_index_js__WEBPACK_IMPORTED_MODULE_0__.Fields.publisherConsents, _model_index_js__WEBPACK_IMPORTED_MODULE_0__.Fields.publisherLegitimateInterests, _model_index_js__WEBPACK_IMPORTED_MODULE_0__.Fields.numCustomPurposes, _model_index_js__WEBPACK_IMPORTED_MODULE_0__.Fields.publisherCustomConsents, _model_index_js__WEBPACK_IMPORTED_MODULE_0__.Fields.publisherCustomLegitimateInterests],
    [_model_index_js__WEBPACK_IMPORTED_MODULE_0__.Segment.VENDORS_ALLOWED]: [_model_index_js__WEBPACK_IMPORTED_MODULE_0__.Fields.vendorsAllowed],
    [_model_index_js__WEBPACK_IMPORTED_MODULE_0__.Segment.VENDORS_DISCLOSED]: [_model_index_js__WEBPACK_IMPORTED_MODULE_0__.Fields.vendorsDisclosed]
  };
}
...
/* harmony export */ });
/* harmony import */ var _FieldSequence_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./FieldSequence.js */ "./iab-tcf-core/encoder/sequence/FieldSequence.js");
/* harmony import */ var _SegmentSequence_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SegmentSequence.js */ "./iab-tcf-core/encoder/sequence/SegmentSequence.js");
/* harmony import */ var _SequenceVersionMap_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SequenceVersionMap.js */ "./iab-tcf-core/encoder/sequence/SequenceVersionMap.js");
...
/* harmony export */ });
/* harmony import */ var _DecodingError_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DecodingError.js */ "./iab-tcf-core/errors/DecodingError.js");
/* harmony import */ var _EncodingError_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EncodingError.js */ "./iab-tcf-core/errors/EncodingError.js");
/* harmony import */ var _GVLError_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./GVLError.js */ "./iab-tcf-core/errors/GVLError.js");
/* harmony import */ var _TCModelError_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./TCModelError.js */ "./iab-tcf-core/errors/TCModelError.js");
...
/* harmony import */ var _errors_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./errors/index.js */ "./iab-tcf-core/errors/index.js");
/* harmony import */ var _model_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/index.js */ "./iab-tcf-core/model/index.js");
/* harmony import */ var _Cloneable_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Cloneable.js */ "./iab-tcf-core/Cloneable.js");
/* harmony import */ var _GVL_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./GVL.js */ "./iab-tcf-core/GVL.js");
/* harmony import */ var _Json_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Json.js */ "./iab-tcf-core/Json.js");
/* harmony import */ var _TCModel_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./TCModel.js */ "./iab-tcf-core/TCModel.js");
/* harmony import */ var _TCString_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./TCString.js */ "./iab-tcf-core/TCString.js");
// created from 'create-ts-index'
...
/***/ "./iab-tcf-core/model/BinarySearchTree.js":
/*!************************************************!*\
  !*** ./iab-tcf-core/model/BinarySearchTree.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class BinarySearchTree extends _Cloneable_js__WEBPACK_IMPORTED_MODULE_0__.Cloneable {
  ...
  add(value) {
    ...
    let current; // first item?

    if (this.isEmpty()) {
      this.root = node;
    } else {
      // start at the root
      current = this.root; // infinite loop, figure out where to put it
      ...
      while (true) {
        ...
        if (value < current.value) {
          ...
          if (current.left === null) {
            // insert on the left
            current.left = node; // our work is done here
  ...
  get() {
    ...
    while (current) {
      if (!current.left) {
        ...
        let pre = current.left; // when pre.right == null, it means we go to the right most leaf
        ...
        if (pre.right == current) {
          pre.right = null; // means the current node is pointed by left right most child
  ...
  remove(value, current = this.root) {
    ...
    while (current) {
      if (value < current.value) {
        ...
        parent = current; // value is less than current value, so go left

        current = current.left;
        parentSide = 'left';
      } else if (value > current.value) {
        // set our parent to the current value
        parent = current; // value is greater than current value, so go right
        ...
        if (!current.left && !current.right) {
           ...
           */
          const minVal = this.min(current.right); // little bit of recursion...
...
class ConsentLanguages {
  static langSet = new Set(["AR", "BG", "BS", "CA", "CS", "DA", "DE", "EL", "EN", "ES", "ET", "EU", "FI", "FR", "GL", "HR", "HU", "IT", "JA", "LT", "LV", "MT", "NL", "NO", "PL", "PT", "PT-BR", "RO", "RU", "SK", "SL", "SR", "SV", "TR", "ZH"]);
...
/* harmony import */ var _Cloneable_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Cloneable.js */ "./iab-tcf-core/Cloneable.js");
/* harmony import */ var _errors_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../errors/index.js */ "./iab-tcf-core/errors/index.js");
/* harmony import */ var _RestrictionType_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./RestrictionType.js */ "./iab-tcf-core/model/RestrictionType.js");
...
class PurposeRestriction extends _Cloneable_js__WEBPACK_IMPORTED_MODULE_0__.Cloneable {
  ...
  isValid() {
    return Number.isInteger(this.purposeId) && this.purposeId > 0 && (this.restrictionType === _RestrictionType_js__WEBPACK_IMPORTED_MODULE_2__.RestrictionType.NOT_ALLOWED || this.restrictionType === _RestrictionType_js__WEBPACK_IMPORTED_MODULE_2__.RestrictionType.REQUIRE_CONSENT || this.restrictionType === _RestrictionType_js__WEBPACK_IMPORTED_MODULE_2__.RestrictionType.REQUIRE_LI);
  }
...
/* harmony export */ });
/* harmony import */ var _PurposeRestriction_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PurposeRestriction.js */ "./iab-tcf-core/model/PurposeRestriction.js");
/* harmony import */ var _BinarySearchTree_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BinarySearchTree.js */ "./iab-tcf-core/model/BinarySearchTree.js");
/* harmony import */ var _RestrictionType_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./RestrictionType.js */ "./iab-tcf-core/model/RestrictionType.js");
/* harmony import */ var _Cloneable_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Cloneable.js */ "./iab-tcf-core/Cloneable.js");
...
class PurposeRestrictionVector extends _Cloneable_js__WEBPACK_IMPORTED_MODULE_3__.Cloneable {
  ...
  remove(vendorId, purposeRestriction) {
    ...
    if (bst) {
      bst.remove(vendorId); // if it's empty let's delete the key so it doesn't show up empty
...
/* harmony export */ });
/* harmony import */ var _Segment_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Segment.js */ "./iab-tcf-core/model/Segment.js");
...
class SegmentIDs {
   ...
   * 3 = PublisherTC
   */
  static ID_TO_KEY = [_Segment_js__WEBPACK_IMPORTED_MODULE_0__.Segment.CORE, _Segment_js__WEBPACK_IMPORTED_MODULE_0__.Segment.VENDORS_DISCLOSED, _Segment_js__WEBPACK_IMPORTED_MODULE_0__.Segment.VENDORS_ALLOWED, _Segment_js__WEBPACK_IMPORTED_MODULE_0__.Segment.PUBLISHER_TC];
  static KEY_TO_ID = {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ByPurposeVendorMap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ByPurposeVendorMap.js */ "./iab-tcf-core/model/gvl/ByPurposeVendorMap.js");
/* harmony import */ var _Declarations_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Declarations.js */ "./iab-tcf-core/model/gvl/Declarations.js");
/* harmony import */ var _Feature_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Feature.js */ "./iab-tcf-core/model/gvl/Feature.js");
/* harmony import */ var _GVLMapItem_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./GVLMapItem.js */ "./iab-tcf-core/model/gvl/GVLMapItem.js");
/* harmony import */ var _IDSetMap_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./IDSetMap.js */ "./iab-tcf-core/model/gvl/IDSetMap.js");
/* harmony import */ var _Purpose_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Purpose.js */ "./iab-tcf-core/model/gvl/Purpose.js");
/* harmony import */ var _Stack_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Stack.js */ "./iab-tcf-core/model/gvl/Stack.js");
/* harmony import */ var _Vendor_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Vendor.js */ "./iab-tcf-core/model/gvl/Vendor.js");
/* harmony import */ var _VendorList_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./VendorList.js */ "./iab-tcf-core/model/gvl/VendorList.js");
// created from 'create-ts-index'
...
/* harmony export */ });
/* harmony import */ var _BinarySearchTree_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BinarySearchTree.js */ "./iab-tcf-core/model/BinarySearchTree.js");
/* harmony import */ var _ConsentLanguages_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ConsentLanguages.js */ "./iab-tcf-core/model/ConsentLanguages.js");
/* harmony import */ var _Fields_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Fields.js */ "./iab-tcf-core/model/Fields.js");
/* harmony import */ var _IntMap_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./IntMap.js */ "./iab-tcf-core/model/IntMap.js");
/* harmony import */ var _KeyMap_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./KeyMap.js */ "./iab-tcf-core/model/KeyMap.js");
/* harmony import */ var _PurposeRestriction_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./PurposeRestriction.js */ "./iab-tcf-core/model/PurposeRestriction.js");
/* harmony import */ var _PurposeRestrictionVector_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./PurposeRestrictionVector.js */ "./iab-tcf-core/model/PurposeRestrictionVector.js");
/* harmony import */ var _DeviceDisclosureStorageAccessType_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./DeviceDisclosureStorageAccessType.js */ "./iab-tcf-core/model/DeviceDisclosureStorageAccessType.js");
/* harmony import */ var _DeviceDisclosure_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./DeviceDisclosure.js */ "./iab-tcf-core/model/DeviceDisclosure.js");
/* harmony import */ var _RestrictionType_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./RestrictionType.js */ "./iab-tcf-core/model/RestrictionType.js");
/* harmony import */ var _Segment_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Segment.js */ "./iab-tcf-core/model/Segment.js");
/* harmony import */ var _SegmentIDs_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./SegmentIDs.js */ "./iab-tcf-core/model/SegmentIDs.js");
/* harmony import */ var _Vector_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Vector.js */ "./iab-tcf-core/model/Vector.js");
/* harmony import */ var _gvl_index_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./gvl/index.js */ "./iab-tcf-core/model/gvl/index.js");
...
/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/CallResponder.js":
/*!**************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/CallResponder.js ***!
  \**************************************************************/
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:!0})),exports.CmpApiModel=void 0;var index_js_1=__webpack_require__(/*! ./status/index.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/status/index.js"),EventListenerQueue_js_1=__webpack_require__(/*! ./EventListenerQueue.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/EventListenerQueue.js"),CmpApiModel=function(){function e(){}return e.reset=function(){delete this.cmpId,delete this.cmpVersion,delete this.eventStatus,delete this.gdprApplies,delete this.tcModel,delete this.tcString,delete this.tcfPolicyVersion,this.cmpStatus=index_js_1.CmpStatus.LOADING,this.disabled=!1,this.displayStatus=index_js_1.DisplayStatus.HIDDEN,this.eventQueue.clear()},e.apiVersion="2",e.eventQueue=new EventListenerQueue_js_1.EventListenerQueue,e.cmpStatus=index_js_1.CmpStatus.LOADING,e.disabled=!1,e.displayStatus=index_js_1.DisplayStatus.HIDDEN,e}();exports.CmpApiModel=CmpApiModel;

/***/ }),

/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/CustomCommands.js":
/*!***************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/CustomCommands.js ***!
  \***************************************************************/
...
/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/EventListenerQueue.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/EventListenerQueue.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:!0})),exports.EventListenerQueue=void 0;var GetTCDataCommand_js_1=__webpack_require__(/*! ./command/GetTCDataCommand.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/GetTCDataCommand.js"),EventListenerQueue=function(){function e(){this.eventQueue=new Map,this.queueNumber=0}return e.prototype.add=function(e){return this.eventQueue.set(this.queueNumber,e),this.queueNumber++},e.prototype.remove=function(e){return this.eventQueue.delete(e)},e.prototype.exec=function(){this.eventQueue.forEach((function(e,t){new GetTCDataCommand_js_1.GetTCDataCommand(e.callback,e.param,t,e.next)}))},e.prototype.clear=function(){this.queueNumber=0,this.eventQueue.clear()},Object.defineProperty(e.prototype,"size",{get:function(){return this.eventQueue.size},enumerable:!1,configurable:!0}),e}();exports.EventListenerQueue=EventListenerQueue;

/***/ }),

/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/SupportedVersions.js":
/*!******************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/SupportedVersions.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/AddEventListenerCommand.js":
/*!********************************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/command/AddEventListenerCommand.js ***!
  \********************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/CommandCallback.js":
/*!************************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/command/CommandCallback.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/CommandMap.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/command/CommandMap.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:!0})),exports.CommandMap=void 0;var PingCommand_js_1=__webpack_require__(/*! ./PingCommand.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/PingCommand.js"),GetTCDataCommand_js_1=__webpack_require__(/*! ./GetTCDataCommand.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/GetTCDataCommand.js"),GetInAppTCDataCommand_js_1=__webpack_require__(/*! ./GetInAppTCDataCommand.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/GetInAppTCDataCommand.js"),GetVendorListCommand_js_1=__webpack_require__(/*! ./GetVendorListCommand.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/GetVendorListCommand.js"),AddEventListenerCommand_js_1=__webpack_require__(/*! ./AddEventListenerCommand.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/AddEventListenerCommand.js"),RemoveEventListenerCommand_js_1=__webpack_require__(/*! ./RemoveEventListenerCommand.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/RemoveEventListenerCommand.js"),TCFCommand_js_1=__webpack_require__(/*! ./TCFCommand.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/TCFCommand.js"),CommandMap=function(){function m(){}var n,e,C,a,o,d;return n=TCFCommand_js_1.TCFCommand.PING,e=TCFCommand_js_1.TCFCommand.GET_TC_DATA,C=TCFCommand_js_1.TCFCommand.GET_IN_APP_TC_DATA,a=TCFCommand_js_1.TCFCommand.GET_VENDOR_LIST,o=TCFCommand_js_1.TCFCommand.ADD_EVENT_LISTENER,d=TCFCommand_js_1.TCFCommand.REMOVE_EVENT_LISTENER,m[n]=PingCommand_js_1.PingCommand,m[e]=GetTCDataCommand_js_1.GetTCDataCommand,m[C]=GetInAppTCDataCommand_js_1.GetInAppTCDataCommand,m[a]=GetVendorListCommand_js_1.GetVendorListCommand,m[o]=AddEventListenerCommand_js_1.AddEventListenerCommand,m[d]=RemoveEventListenerCommand_js_1.RemoveEventListenerCommand,m}();exports.CommandMap=CommandMap;

/***/ }),

/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/GetInAppTCDataCommand.js":
/*!******************************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/command/GetInAppTCDataCommand.js ***!
  \******************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/index.js":
/*!**************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/command/index.js ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(e,t,r,i){void 0===i&&(i=r),Object.defineProperty(e,i,{enumerable:!0,get:function(){return t[r]}})}:function(e,t,r,i){void 0===i&&(i=r),e[i]=t[r]}),__exportStar=this&&this.__exportStar||function(e,t){for(var r in e)"default"===r||Object.prototype.hasOwnProperty.call(t,r)||__createBinding(t,e,r)};Object.defineProperty(exports, "__esModule", ({value:!0})),__exportStar(__webpack_require__(/*! ./TCFCommand.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/TCFCommand.js"),exports),__exportStar(__webpack_require__(/*! ./CommandCallback.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/CommandCallback.js"),exports);

/***/ }),

/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/index.js":
/*!******************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/index.js ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(e,r,t,o){void 0===o&&(o=t),Object.defineProperty(e,o,{enumerable:!0,get:function(){return r[t]}})}:function(e,r,t,o){void 0===o&&(o=t),e[o]=r[t]}),__exportStar=this&&this.__exportStar||function(e,r){for(var t in e)"default"===t||Object.prototype.hasOwnProperty.call(r,t)||__createBinding(r,e,t)};Object.defineProperty(exports, "__esModule", ({value:!0})),exports.API_KEY=void 0,__exportStar(__webpack_require__(/*! ./command/index.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/command/index.js"),exports),__exportStar(__webpack_require__(/*! ./response/index.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/response/index.js"),exports),__exportStar(__webpack_require__(/*! ./status/index.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/status/index.js"),exports),__exportStar(__webpack_require__(/*! ./CmpApi.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/CmpApi.js"),exports),__exportStar(__webpack_require__(/*! ./CmpApiModel.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/CmpApiModel.js"),exports),__exportStar(__webpack_require__(/*! ./CustomCommands.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/CustomCommands.js"),exports);var CallResponder_js_1=__webpack_require__(/*! ./CallResponder.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/CallResponder.js");Object.defineProperty(exports, "API_KEY", ({enumerable:!0,get:function(){return CallResponder_js_1.API_KEY}}));

/***/ }),

/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/response/Disabled.js":
/*!******************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/response/Disabled.js ***!
  \******************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
var __extends=this&&this.__extends||function(){var t=function(e,n){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n])})(e,n)};return function(e,n){if("function"!=typeof n&&null!==n)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null");function r(){this.constructor=e}t(e,n),e.prototype=null===n?Object.create(n):(r.prototype=n.prototype,new r)}}();Object.defineProperty(exports, "__esModule", ({value:!0})),exports.Disabled=void 0;var Response_js_1=__webpack_require__(/*! ./Response.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/response/Response.js"),index_js_1=__webpack_require__(/*! ../status/index.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/status/index.js"),Disabled=function(t){function e(){var e=null!==t&&t.apply(this,arguments)||this;return e.cmpStatus=index_js_1.CmpStatus.ERROR,e}return __extends(e,t),e}(Response_js_1.Response);exports.Disabled=Disabled;

/***/ }),

/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/response/InAppTCData.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/response/InAppTCData.js ***!
  \*********************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/response/index.js":
/*!***************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/response/index.js ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(e,r,t,i){void 0===i&&(i=t),Object.defineProperty(e,i,{enumerable:!0,get:function(){return r[t]}})}:function(e,r,t,i){void 0===i&&(i=t),e[i]=r[t]}),__exportStar=this&&this.__exportStar||function(e,r){for(var t in e)"default"===t||Object.prototype.hasOwnProperty.call(r,t)||__createBinding(r,e,t)};Object.defineProperty(exports, "__esModule", ({value:!0})),__exportStar(__webpack_require__(/*! ./Disabled.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/response/Disabled.js"),exports),__exportStar(__webpack_require__(/*! ./InAppTCData.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/response/InAppTCData.js"),exports),__exportStar(__webpack_require__(/*! ./Ping.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/response/Ping.js"),exports),__exportStar(__webpack_require__(/*! ./Response.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/response/Response.js"),exports),__exportStar(__webpack_require__(/*! ./TCData.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/response/TCData.js"),exports);

/***/ }),

/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/status/CmpStatus.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/status/CmpStatus.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/status/DisplayStatus.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/status/DisplayStatus.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/status/EventStatus.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/status/EventStatus.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/cmpapi/lib/cjs/status/index.js":
/*!*************************************************************!*\
  !*** ./node_modules/@iabtcf/cmpapi/lib/cjs/status/index.js ***!
  \*************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(t,e,r,i){void 0===i&&(i=r),Object.defineProperty(t,i,{enumerable:!0,get:function(){return e[r]}})}:function(t,e,r,i){void 0===i&&(i=r),t[i]=e[r]}),__exportStar=this&&this.__exportStar||function(t,e){for(var r in t)"default"===r||Object.prototype.hasOwnProperty.call(e,r)||__createBinding(e,t,r)};Object.defineProperty(exports, "__esModule", ({value:!0})),__exportStar(__webpack_require__(/*! ./CmpStatus.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/status/CmpStatus.js"),exports),__exportStar(__webpack_require__(/*! ./DisplayStatus.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/status/DisplayStatus.js"),exports),__exportStar(__webpack_require__(/*! ./EventStatus.js */ "./node_modules/@iabtcf/cmpapi/lib/cjs/status/EventStatus.js"),exports);

/***/ }),

/***/ "./node_modules/@iabtcf/core/lib/cjs/Cloneable.js":
/*!********************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/Cloneable.js ***!
  \********************************************************/
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/GVL.js":
/*!**************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/GVL.js ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/TCModel.js":
/*!******************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/TCModel.js ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/DateEncoder.js":
/*!************************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/encoder/field/DateEncoder.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:!0})),exports.DateEncoder=void 0;var IntEncoder_js_1=__webpack_require__(/*! ./IntEncoder.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/IntEncoder.js"),index_js_1=__webpack_require__(/*! ../../errors/index.js */ "./node_modules/@iabtcf/core/lib/cjs/errors/index.js"),DateEncoder=function(){function e(){}return e.encode=function(e,n){return IntEncoder_js_1.IntEncoder.encode(Math.round(e.getTime()/100),n)},e.decode=function(e,n){if(n!==e.length)throw new index_js_1.DecodingError("invalid bit length");var r=new Date;return r.setTime(100*IntEncoder_js_1.IntEncoder.decode(e,n)),r},e}();exports.DateEncoder=DateEncoder;
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:!0})),exports.FixedVectorEncoder=void 0;var BooleanEncoder_js_1=__webpack_require__(/*! ./BooleanEncoder.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/BooleanEncoder.js"),index_js_1=__webpack_require__(/*! ../../errors/index.js */ "./node_modules/@iabtcf/core/lib/cjs/errors/index.js"),index_js_2=__webpack_require__(/*! ../../model/index.js */ "./node_modules/@iabtcf/core/lib/cjs/model/index.js"),FixedVectorEncoder=function(){function e(){}return e.encode=function(e,o){for(var n="",r=1;r<=o;r++)n+=BooleanEncoder_js_1.BooleanEncoder.encode(e.has(r));return n},e.decode=function(e,o){if(e.length!==o)throw new index_js_1.DecodingError("bitfield encoding length mismatch");for(var n=new index_js_2.Vector,r=1;r<=o;r++)BooleanEncoder_js_1.BooleanEncoder.decode(e[r-1])&&n.set(r);return n.bitLength=e.length,n},e}();exports.FixedVectorEncoder=FixedVectorEncoder;

/***/ }),

/***/ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/IntEncoder.js":
/*!***********************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/encoder/field/IntEncoder.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:!0})),exports.IntEncoder=void 0;var index_js_1=__webpack_require__(/*! ../../errors/index.js */ "./node_modules/@iabtcf/core/lib/cjs/errors/index.js"),IntEncoder=function(){function e(){}return e.encode=function(e,n){var t;if("string"==typeof e&&(e=parseInt(e,10)),(t=e.toString(2)).length>n||e<0)throw new index_js_1.EncodingError("".concat(e," too large to encode into ").concat(n));return t.length<n&&(t="0".repeat(n-t.length)+t),t},e.decode=function(e,n){if(n!==e.length)throw new index_js_1.DecodingError("invalid bit length");return parseInt(e,2)},e}();exports.IntEncoder=IntEncoder;

/***/ }),

/***/ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/LangEncoder.js":
/*!************************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/encoder/field/LangEncoder.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(e,r,t,o){void 0===o&&(o=t),Object.defineProperty(e,o,{enumerable:!0,get:function(){return r[t]}})}:function(e,r,t,o){void 0===o&&(o=t),e[o]=r[t]}),__exportStar=this&&this.__exportStar||function(e,r){for(var t in e)"default"===t||Object.prototype.hasOwnProperty.call(r,t)||__createBinding(r,e,t)};Object.defineProperty(exports, "__esModule", ({value:!0})),__exportStar(__webpack_require__(/*! ./BooleanEncoder.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/BooleanEncoder.js"),exports),__exportStar(__webpack_require__(/*! ./DateEncoder.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/DateEncoder.js"),exports),__exportStar(__webpack_require__(/*! ./FieldEncoderMap.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/FieldEncoderMap.js"),exports),__exportStar(__webpack_require__(/*! ./FixedVectorEncoder.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/FixedVectorEncoder.js"),exports),__exportStar(__webpack_require__(/*! ./IntEncoder.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/IntEncoder.js"),exports),__exportStar(__webpack_require__(/*! ./LangEncoder.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/LangEncoder.js"),exports),__exportStar(__webpack_require__(/*! ./PurposeRestrictionVectorEncoder.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/PurposeRestrictionVectorEncoder.js"),exports),__exportStar(__webpack_require__(/*! ./VectorEncodingType.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/VectorEncodingType.js"),exports),__exportStar(__webpack_require__(/*! ./VendorVectorEncoder.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/VendorVectorEncoder.js"),exports);
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(e,r,t,i){void 0===i&&(i=t),Object.defineProperty(e,i,{enumerable:!0,get:function(){return r[t]}})}:function(e,r,t,i){void 0===i&&(i=t),e[i]=r[t]}),__exportStar=this&&this.__exportStar||function(e,r){for(var t in e)"default"===t||Object.prototype.hasOwnProperty.call(r,t)||__createBinding(r,e,t)};Object.defineProperty(exports, "__esModule", ({value:!0})),__exportStar(__webpack_require__(/*! ./Base64Url.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/Base64Url.js"),exports),__exportStar(__webpack_require__(/*! ./BitLength.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/BitLength.js"),exports),__exportStar(__webpack_require__(/*! ./EncodingOptions.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/EncodingOptions.js"),exports),__exportStar(__webpack_require__(/*! ./SegmentEncoder.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/SegmentEncoder.js"),exports),__exportStar(__webpack_require__(/*! ./SemanticPreEncoder.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/SemanticPreEncoder.js"),exports),__exportStar(__webpack_require__(/*! ./field/index.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/field/index.js"),exports),__exportStar(__webpack_require__(/*! ./sequence/index.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/sequence/index.js"),exports);

/***/ }),

/***/ "./node_modules/@iabtcf/core/lib/cjs/encoder/sequence/FieldSequence.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/encoder/sequence/FieldSequence.js ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:!0})),exports.SegmentSequence=void 0;var index_js_1=__webpack_require__(/*! ../../model/index.js */ "./node_modules/@iabtcf/core/lib/cjs/model/index.js"),SegmentSequence=function(e,s){if(this[1]=[index_js_1.Segment.CORE],this[2]=[index_js_1.Segment.CORE],2===e.version)if(e.isServiceSpecific)this[2].push(index_js_1.Segment.PUBLISHER_TC);else{var i=!(!s||!s.isForVendors);i&&!0!==e[index_js_1.Fields.supportOOB]||this[2].push(index_js_1.Segment.VENDORS_DISCLOSED),i&&(e[index_js_1.Fields.supportOOB]&&e[index_js_1.Fields.vendorsAllowed].size>0&&this[2].push(index_js_1.Segment.VENDORS_ALLOWED),this[2].push(index_js_1.Segment.PUBLISHER_TC))}};exports.SegmentSequence=SegmentSequence;

/***/ }),

/***/ "./node_modules/@iabtcf/core/lib/cjs/encoder/sequence/SequenceVersionMap.js":
/*!**********************************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/encoder/sequence/SequenceVersionMap.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/encoder/sequence/index.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/encoder/sequence/index.js ***!
  \*********************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(e,t,r,i){void 0===i&&(i=r),Object.defineProperty(e,i,{enumerable:!0,get:function(){return t[r]}})}:function(e,t,r,i){void 0===i&&(i=r),e[i]=t[r]}),__exportStar=this&&this.__exportStar||function(e,t){for(var r in e)"default"===r||Object.prototype.hasOwnProperty.call(t,r)||__createBinding(t,e,r)};Object.defineProperty(exports, "__esModule", ({value:!0})),__exportStar(__webpack_require__(/*! ./FieldSequence.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/sequence/FieldSequence.js"),exports),__exportStar(__webpack_require__(/*! ./SegmentSequence.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/sequence/SegmentSequence.js"),exports),__exportStar(__webpack_require__(/*! ./SequenceVersionMap.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/sequence/SequenceVersionMap.js"),exports);

/***/ }),

/***/ "./node_modules/@iabtcf/core/lib/cjs/errors/DecodingError.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/errors/DecodingError.js ***!
  \*******************************************************************/
/***/ (function(__unused_webpack_module, exports) {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/errors/EncodingError.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/errors/EncodingError.js ***!
  \*******************************************************************/
/***/ (function(__unused_webpack_module, exports) {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/errors/GVLError.js":
/*!**************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/errors/GVLError.js ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports) {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/errors/TCModelError.js":
/*!******************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/errors/TCModelError.js ***!
  \******************************************************************/
/***/ (function(__unused_webpack_module, exports) {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/errors/index.js":
/*!***********************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/errors/index.js ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(r,e,t,o){void 0===o&&(o=t),Object.defineProperty(r,o,{enumerable:!0,get:function(){return e[t]}})}:function(r,e,t,o){void 0===o&&(o=t),r[o]=e[t]}),__exportStar=this&&this.__exportStar||function(r,e){for(var t in r)"default"===t||Object.prototype.hasOwnProperty.call(e,t)||__createBinding(e,r,t)};Object.defineProperty(exports, "__esModule", ({value:!0})),__exportStar(__webpack_require__(/*! ./DecodingError.js */ "./node_modules/@iabtcf/core/lib/cjs/errors/DecodingError.js"),exports),__exportStar(__webpack_require__(/*! ./EncodingError.js */ "./node_modules/@iabtcf/core/lib/cjs/errors/EncodingError.js"),exports),__exportStar(__webpack_require__(/*! ./GVLError.js */ "./node_modules/@iabtcf/core/lib/cjs/errors/GVLError.js"),exports),__exportStar(__webpack_require__(/*! ./TCModelError.js */ "./node_modules/@iabtcf/core/lib/cjs/errors/TCModelError.js"),exports);
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(e,r,t,o){void 0===o&&(o=t),Object.defineProperty(e,o,{enumerable:!0,get:function(){return r[t]}})}:function(e,r,t,o){void 0===o&&(o=t),e[o]=r[t]}),__exportStar=this&&this.__exportStar||function(e,r){for(var t in e)"default"===t||Object.prototype.hasOwnProperty.call(r,t)||__createBinding(r,e,t)};Object.defineProperty(exports, "__esModule", ({value:!0})),__exportStar(__webpack_require__(/*! ./encoder/index.js */ "./node_modules/@iabtcf/core/lib/cjs/encoder/index.js"),exports),__exportStar(__webpack_require__(/*! ./errors/index.js */ "./node_modules/@iabtcf/core/lib/cjs/errors/index.js"),exports),__exportStar(__webpack_require__(/*! ./model/index.js */ "./node_modules/@iabtcf/core/lib/cjs/model/index.js"),exports),__exportStar(__webpack_require__(/*! ./Cloneable.js */ "./node_modules/@iabtcf/core/lib/cjs/Cloneable.js"),exports),__exportStar(__webpack_require__(/*! ./GVL.js */ "./node_modules/@iabtcf/core/lib/cjs/GVL.js"),exports),__exportStar(__webpack_require__(/*! ./Json.js */ "./node_modules/@iabtcf/core/lib/cjs/Json.js"),exports),__exportStar(__webpack_require__(/*! ./TCModel.js */ "./node_modules/@iabtcf/core/lib/cjs/TCModel.js"),exports),__exportStar(__webpack_require__(/*! ./TCString.js */ "./node_modules/@iabtcf/core/lib/cjs/TCString.js"),exports);

/***/ }),

/***/ "./node_modules/@iabtcf/core/lib/cjs/model/BinarySearchTree.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/BinarySearchTree.js ***!
  \*********************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/DeviceDisclosure.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/DeviceDisclosure.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/DeviceDisclosureStorageAccessType.js":
/*!**************************************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/DeviceDisclosureStorageAccessType.js ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/Fields.js":
/*!***********************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/Fields.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/IntMap.js":
/*!***********************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/IntMap.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/KeyMap.js":
/*!***********************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/KeyMap.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/PurposeRestriction.js":
/*!***********************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/PurposeRestriction.js ***!
  \***********************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/Segment.js":
/*!************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/Segment.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/SegmentIDs.js":
/*!***************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/SegmentIDs.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/Declarations.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/gvl/Declarations.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/Feature.js":
/*!****************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/gvl/Feature.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/GVLMapItem.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/gvl/GVLMapItem.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/IDSetMap.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/gvl/IDSetMap.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/Purpose.js":
/*!****************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/gvl/Purpose.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/Stack.js":
/*!**************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/gvl/Stack.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/Vendor.js":
/*!***************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/gvl/Vendor.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/VendorList.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/gvl/VendorList.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/index.js":
/*!**************************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/gvl/index.js ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(e,r,t,o){void 0===o&&(o=t),Object.defineProperty(e,o,{enumerable:!0,get:function(){return r[t]}})}:function(e,r,t,o){void 0===o&&(o=t),e[o]=r[t]}),__exportStar=this&&this.__exportStar||function(e,r){for(var t in e)"default"===t||Object.prototype.hasOwnProperty.call(r,t)||__createBinding(r,e,t)};Object.defineProperty(exports, "__esModule", ({value:!0})),__exportStar(__webpack_require__(/*! ./ByPurposeVendorMap.js */ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/ByPurposeVendorMap.js"),exports),__exportStar(__webpack_require__(/*! ./Declarations.js */ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/Declarations.js"),exports),__exportStar(__webpack_require__(/*! ./Feature.js */ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/Feature.js"),exports),__exportStar(__webpack_require__(/*! ./GVLMapItem.js */ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/GVLMapItem.js"),exports),__exportStar(__webpack_require__(/*! ./IDSetMap.js */ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/IDSetMap.js"),exports),__exportStar(__webpack_require__(/*! ./Purpose.js */ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/Purpose.js"),exports),__exportStar(__webpack_require__(/*! ./Stack.js */ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/Stack.js"),exports),__exportStar(__webpack_require__(/*! ./Vendor.js */ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/Vendor.js"),exports),__exportStar(__webpack_require__(/*! ./VendorList.js */ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/VendorList.js"),exports);

/***/ }),

/***/ "./node_modules/@iabtcf/core/lib/cjs/model/index.js":
/*!**********************************************************!*\
  !*** ./node_modules/@iabtcf/core/lib/cjs/model/index.js ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
var __createBinding=this&&this.__createBinding||(Object.create?function(e,r,t,o){void 0===o&&(o=t),Object.defineProperty(e,o,{enumerable:!0,get:function(){return r[t]}})}:function(e,r,t,o){void 0===o&&(o=t),e[o]=r[t]}),__exportStar=this&&this.__exportStar||function(e,r){for(var t in e)"default"===t||Object.prototype.hasOwnProperty.call(r,t)||__createBinding(r,e,t)};Object.defineProperty(exports, "__esModule", ({value:!0})),__exportStar(__webpack_require__(/*! ./BinarySearchTree.js */ "./node_modules/@iabtcf/core/lib/cjs/model/BinarySearchTree.js"),exports),__exportStar(__webpack_require__(/*! ./ConsentLanguages.js */ "./node_modules/@iabtcf/core/lib/cjs/model/ConsentLanguages.js"),exports),__exportStar(__webpack_require__(/*! ./Fields.js */ "./node_modules/@iabtcf/core/lib/cjs/model/Fields.js"),exports),__exportStar(__webpack_require__(/*! ./IntMap.js */ "./node_modules/@iabtcf/core/lib/cjs/model/IntMap.js"),exports),__exportStar(__webpack_require__(/*! ./KeyMap.js */ "./node_modules/@iabtcf/core/lib/cjs/model/KeyMap.js"),exports),__exportStar(__webpack_require__(/*! ./PurposeRestriction.js */ "./node_modules/@iabtcf/core/lib/cjs/model/PurposeRestriction.js"),exports),__exportStar(__webpack_require__(/*! ./PurposeRestrictionVector.js */ "./node_modules/@iabtcf/core/lib/cjs/model/PurposeRestrictionVector.js"),exports),__exportStar(__webpack_require__(/*! ./DeviceDisclosureStorageAccessType.js */ "./node_modules/@iabtcf/core/lib/cjs/model/DeviceDisclosureStorageAccessType.js"),exports),__exportStar(__webpack_require__(/*! ./DeviceDisclosure.js */ "./node_modules/@iabtcf/core/lib/cjs/model/DeviceDisclosure.js"),exports),__exportStar(__webpack_require__(/*! ./RestrictionType.js */ "./node_modules/@iabtcf/core/lib/cjs/model/RestrictionType.js"),exports),__exportStar(__webpack_require__(/*! ./Segment.js */ "./node_modules/@iabtcf/core/lib/cjs/model/Segment.js"),exports),__exportStar(__webpack_require__(/*! ./SegmentIDs.js */ "./node_modules/@iabtcf/core/lib/cjs/model/SegmentIDs.js"),exports),__exportStar(__webpack_require__(/*! ./Vector.js */ "./node_modules/@iabtcf/core/lib/cjs/model/Vector.js"),exports),__exportStar(__webpack_require__(/*! ./gvl/index.js */ "./node_modules/@iabtcf/core/lib/cjs/model/gvl/index.js"),exports);
...
(() => {
/*!*******************************************!*\
  !*** ./6W6C3zMwTsLUlar7FwOJZ-original.js ***!
  \*******************************************/
...
function _ckyPushGTMConsentData() {
  if (arguments[0] && typeof arguments[0] === "object") window.dataLayer.push(arguments[0]);else window.dataLayer.push(arguments);
}
...
function _ckyFindHeaders() {
  const languageDictionary = ref._ckyStore._language._store.get(ref._ckyStore._language._active);

  const headerKeys = [];

  for (const key in languageDictionary) if (key.includes(`cky_audit_table_header_`)) headerKeys.push(key.replace(`cky_audit_table_header_`, ""));
...
function _ckyGetValueFromMap(key, dictionary) {
  ...
  if (/cookies\.(.*\..*)\..*/gm.test(key)) allKeys = [allKeys[0], allKeys.slice(1, -1).join("."), allKeys[allKeys.length - 1]];
...
function _ckyPrepareHTML(htmlContent) {
  ...
  const keysToReplace = Object.keys(languageDictionary).reduce((prev, curr) => {
    if (curr.startsWith(`cky_`)) prev[`[${curr}]`] = languageDictionary[curr];
    return prev;
  }, {});
  const reToReplace = new RegExp(Object.keys(keysToReplace).join("|").replace(/[\[\]]/g, "\\$&"), "gi");
  htmlContent = htmlContent.replace(reToReplace, matched => keysToReplace[matched]);
  return htmlContent;
}

function _ckyCheckPreview() {
  if (!location.search) return false;
  return location.search.substring(1).split("&").some(item => {
    const [key, value] = item.split("=").map(val => decodeURIComponent(val));
...
function _ckyReplaceKeysInText(hayStack) {
  const replaceKey = (key, value = null, treatment = 1) => {
    ...
    hayStack = hayStack.replaceAll(processedKey, value === null ? _ckyGetTranslation(key) : value);
  };
...
function _ckyCleanNodesWithClasses(list, keyPreffix, selectedItemID, accordionClass = ".cky-accordion-btn") {
  const itemIDsWithClass = [];
  const activeClass = "cky-accordion-active";
  list.forEach(currItem => {
    if (currItem.id === selectedItemID) return;
    const currentItemID = `#${keyPreffix}${currItem.id}`;
    if (_ckyHasClass(currentItemID, activeClass, false)) itemIDsWithClass.push(currentItemID);
  });
...
function _ckyUnblock() {
  ...
  if (ref._ckyStore._bannerConfig.activeLaw === "gdpr" && (!ckyconsent || ckyconsent !== "yes") && ref._ckyStore._categories.every(cat => cat.isNecessary || ref._ckyGetFromStore(cat.slug) === "no")) return;
...
function _ckyAcceptCookies(choice = "all") {
  ...
  for (const category of ref._ckyStore._categories) {
    let valueToSet = !category.isNecessary && (choice === "reject" || choice === "custom" && !_ckyFindCheckBoxValue(category.slug)) ? "no" : "yes";
  ...
  if (reloadOnAccept) location.reload();else _ckyUnblock();
...
function _ckySetInitialState() {
  ...
  ref._ckySetInStore("consent", activeLaw === "ccpa" && shouldFollowGPC ? "yes" : "no");
  ...
  for (const category of ref._ckyStore._categories) {
    let valueToSet = "yes";
    if (!category.isNecessary && !category.defaultConsent[activeLaw]) valueToSet = "no";
...
function _ckyRemoveDeadCookies({
  ...
  for (const {
    ...
    if (cookieToReset) {
      [domain, "", window.location.host].map(cookieDomain => ref._ckySetCookie(cookieToReset, "", 0, cookieDomain));
...
function getKeyToReset(objectData, keyToSearch) {
  ...
  const dataToReset = Object.keys(objectData).find(key => new RegExp(keyToSearch).test(key));
  return dataToReset;
}
...
function _ckySetGoogleConsentMode() {
  ...
  _ckyPushGTMConsentData("set", "ads_data_redaction", advertisementConsent === "denied");

  _ckyPushGTMConsentData("set", "url_passthrough", analyticsConsent === "denied");
...
async function _ckyFindApplyingRule() {
  try {
    if (window.ckySettings && window.ckySettings.ruleSet) ref.ruleSet = window.ckySettings.ruleSet;else {
      const response = await _ckyRequest(`https://scriptstaging.cookieyes.com/client_data/3a8196c3494857295a4ab43b/64-devQn.json`);
    ...
    for (const rule of ref.ruleSet) {
      if (rule.condition === "all" || _ckyParseRule(rule.condition)) return ref._ckyStore._banners[rule.targetBanner];
    }

    if (ref._ckyStore._ruleData._geoIPFailed) {
      const rule = ref.ruleSet[ref.ruleSet.length - 1];
      return ref._ckyStore._banners[rule.targetBanner];
    }
  } catch (error) {}
...
function _ckyParseRule(rule) {
  ...
  for (const rule of rules) {
    ...
    if (isOrRule && ruleOutput) return true;else if (!isOrRule && !ruleOutput) return false;
  }
...
function _ckyCheckRule(condition) {
  ...
  switch (true) {
    ...
    case / IN /i.test(condition):
      return rhs.replace(/\[|\]/g, "").split(",").includes(_ckyParseRuleLHS(lhs));
...
window.performBannerAction = action => {
  const acceptStatus = action === "accept_all" ? "all" : action === "accept_partial" ? "custom" : "reject";
...
function _ckyPreferenceCenterControl(show = true) {
  ...
  if (activeLaw === "gdpr") fnToCall("=detail", "cky-modal-open");else fnToCall("=optout-popup", "cky-modal-open");
}
...
function _ckyBannerControl(show = true) {
  ...
  if (ref._ckyStore._bannerConfig.bannerType === "popup") fnToCall(".cky-overlay", "cky-hide", false);
}
...
function _ckyPopulateInsideAuditTable() {
  const auditTableCode = ref._ckyStore._commonShortCodes.find(code => code.key === "cky_audit_table");

  const auditTableEmpty = ref._ckyStore._commonShortCodes.find(code => code.key === "cky_audit_table_empty");

  for (const category of ref._ckyStore._categories) {
    const categoryTableContent = _ckyGetAuditTableContent(category, auditTableCode.content.container, auditTableEmpty.content.container);

    document.querySelector(`#ckyDetailCategory${category.slug} [data-cky-tag="audit-table"]`).insertAdjacentHTML("beforeend", categoryTableContent);
  }
}

function _ckyGetAuditTableContent(category, auditTableBase, auditTableEmpty) {
  if (category.cookies.length === 0) {
    return auditTableEmpty.replace("[cky_audit_table_empty_text]", _ckyGetTranslation(`cky_audit_table_empty_text`));
  }
  ...
  for (const cookie of category.cookies) {
    ...
    for (const header of ref._ckyStore._auditTable._headerKeys) {
      cookieContent = `${cookieContent}<li><div>${_ckyGetTranslation(`cky_audit_table_header_${header}`)}</div><div>${header === "id" ? cookie.cookieID : _ckyGetTranslation(`cookies.${cookie.cookieID}.${header}`)}</div></li>`;
    }

    categoryContent = `${categoryContent}${auditTableBase.replace("[CONTENT]", cookieContent)}`;
  }
...
function _ckyClearOutsideAuditTable() {
  const auditTableElements = document.querySelectorAll(".cky-audit-table-element");
...
function _ckyGetAuditTableContentForPage(category, auditTableBase) {
  ...
  const {
    _headerKeys: headers
  } = ref._ckyStore._auditTable;
  const auditTableBasePrepared = auditTableBase.replace(`[cky_preference_{{category_slug}}_title]`, _ckyGetTranslation(`cky_preference_${category.slug}_title`));
  let categoryContent = `<thead><tr>`;

  for (const header of headers) {
    categoryContent = `${categoryContent}<th>${_ckyGetTranslation(`cky_audit_table_header_${header}`)}</th>`;
  }
  ...
  for (const cookie of category.cookies) {
    ...
    for (const header of headers) {
      cookieContent = `${cookieContent}<td>${header === "id" ? cookie.cookieID : _ckyGetTranslation(`cookies.${cookie.cookieID}.${header}`)}</td>`;
    }
...
function _ckyWatchAuditTableElement() {
  const auditTableObserver = new MutationObserver(_ckyPopulateOutsideAuditTable);
...
function _ckyReplaceVendorCount(inputHTML) {
  return inputHTML.replaceAll("{{count}}", ref._thirdPartyLists[0].sublist.length + ref._thirdPartyLists[1].sublist.length);
}

function _ckyBuildPurposeAndFeaturesUI(shortCodeFinder) {
  const [purposeFeatureSection, purposeFeatureSectionToggle, purposeFeatureSectionItem, commonLegitimateToggle, commonConsentToggle, purposeFeatureSectionIllustration, purposeFeatureSectionVendorCount] = ["cky_iab_purpose_n_features_section", "cky_iab_purpose_n_features_section_toggle", "cky_iab_purpose_n_features_item", "cky_iab_common_item_legitimate_toggle", "cky_iab_common_item_consent_toggle", "cky_iab_purpose_n_features_item_illustration", "cky_iab_purpose_n_features_item_vendor_count"].map(key => shortCodeFinder(key));
  let sectionHTML = ``;

  ref._pnfTabs.forEach(section => {
    let itemsHTML = ``;

    const [replaceParent, getFinalParent] = _ckyReplaceKeysInText(purposeFeatureSection);

    section.sublist.forEach(itemForSection => {
      const [replaceKey, getFinalText] = _ckyReplaceKeysInText(purposeFeatureSectionItem);

      replaceKey("cky_iab_common_item_consent_toggle", itemForSection.hasConsentToggle ? commonConsentToggle : "");
      replaceKey("cky_iab_common_item_legitimate_toggle", itemForSection.hasLegitimateToggle ? commonLegitimateToggle : "");
      if (itemForSection.hasLegitimateToggle && itemForSection.hasConsentToggle) replaceKey("cky-legitimate-switch-wrapper", "cky-legitimate-switch-wrapper cky-switch-separator", 2);
      let illustrationsText = "";

      if (itemForSection.illustrations.length > 0) {
        const illustrationsContent = itemForSection.illustrations.map(illustration => `<li>${illustration}</li>`);
        illustrationsText = purposeFeatureSectionIllustration.replace("[CONTENT]", illustrationsContent.join(""));
      }

      replaceKey("cky_iab_purpose_n_features_item_illustration", illustrationsText);
      const countDataText = purposeFeatureSectionVendorCount.replace("[COUNT_DATA]", `${itemForSection.combinedSeeker ? "[cky_iab_purpose_n_feature_vendors_seeking_combained]" : "[cky_iab_purpose_n_feature_vendors_seeking_consent]"}: ${itemForSection.seekerCount}`);
      replaceKey("cky_iab_purpose_n_features_item_vendor_count", countDataText);
      replaceKey("ITEM_ID", `ckyIABPNFSection${section.id}Item${itemForSection.id}`);
    ...
    replaceParent("cky_iab_purpose_n_features_section_toggle", section.toggle ? purposeFeatureSectionToggle : "");
...
function _ckyBuildVendorsUI(shortCodeFinder) {
  const [vendorsSection, vendorsSectionToggle, vendorItem, commonLegitimateToggle, commonConsentToggle, vendorItemLegitimateLink, vendorItemDataRetention, vendorItemDataRetentionMessage, vendorItemPurposes, vendorItemTableButton, vendorItemSpecialPurposes, vendorItemFeatures, vendorItemSpecialFeatures, vendorItemDataCategories, vendorItemDeviceOverview] = ["cky_iab_vendors_section", "cky_iab_vendors_section_toggle", "cky_iab_vendors_item", "cky_iab_common_item_legitimate_toggle", "cky_iab_common_item_consent_toggle", "cky_iab_vendors_item_legitimate_interest", "cky_iab_vendors_item_data_retention", "cky_iab_vendors_item_data_retention_message", "cky_iab_vendors_item_purposes", "cky_iab_vendors_item_table_button", "cky_iab_vendors_item_special_purposes", "cky_iab_vendors_item_features", "cky_iab_vendors_item_special_features", "cky_iab_vendors_item_data_categories", "cky_iab_vendors_item_device_overview"].map(key => shortCodeFinder(key));
  let sectionHTML = ``;

  ref._thirdPartyLists.forEach(section => {
    let itemsHTML = ``;

    const [replaceParent, getFinalParent] = _ckyReplaceKeysInText(vendorsSection);
    ...
    section.sublist.forEach(itemForSection => {
      ...
      if (itemForSection.legitimateInterestLink) {
        legitimateInterestLink = vendorItemLegitimateLink.replaceAll("[LEGITIMATE_INTEREST_LINK]", itemForSection.legitimateInterestLink);
      }

      replaceKey("cky_iab_vendors_item_legitimate_interest", legitimateInterestLink);
      let retentionPeriodText = "";

      if (itemForSection.totalRetentionPeriod) {
        const dataRetentionMessage = vendorItemDataRetentionMessage.replace("[DATA_RENTENTION_DAYS]", itemForSection.totalRetentionPeriod);
        retentionPeriodText = vendorItemDataRetention.replace("[cky_iab_vendors_item_data_retention_message]", dataRetentionMessage);
      }

      replaceKey("cky_iab_vendors_item_data_retention", retentionPeriodText);

      const purposesForConsentText = _ckyCreateVendorConsentText(itemForSection.purposesForConsent, "cky_iab_common_consent", vendorItemDataRetentionMessage, vendorItemPurposes);

      const purposesForLegitimateText = _ckyCreateVendorConsentText(itemForSection.purposesForLegitimateInterest, "cky_iab_common_legitimate_interest", vendorItemDataRetentionMessage, vendorItemPurposes);

      replaceKey("cky_iab_vendors_item_purposes", `${purposesForConsentText} ${purposesForLegitimateText}`);

      const specialPurposesText = _ckyCreateVendorOptionalText(itemForSection.specialPurposes, vendorItemSpecialPurposes);

      replaceKey("cky_iab_vendors_item_special_purposes", specialPurposesText);

      const featuresText = _ckyCreateVendorOptionalText(itemForSection.features, vendorItemFeatures);

      replaceKey("cky_iab_vendors_item_features", featuresText);

      const specialFeaturesText = _ckyCreateVendorOptionalText(itemForSection.specialFeatures, vendorItemSpecialFeatures);

      replaceKey("cky_iab_vendors_item_special_features", specialFeaturesText);

      const dataCategoriesText = _ckyCreateVendorOptionalText(itemForSection.dataCategories, vendorItemDataCategories);

      replaceKey("cky_iab_vendors_item_data_categories", dataCategoriesText);
      let deviceStorageOverviewText = "";

      if (!itemForSection.isGoogleVendor) {
        const [replaceSub, getFinalSub] = _ckyReplaceKeysInText(vendorItemDeviceOverview);

        replaceSub("COOKIE_STORAGE_METHOD", itemForSection.cookieStorageMethod === "cookie" ? "[cky_iab_vendors_tracking_method_cookie_message]" : "[cky_iab_vendors_tracking_method_others_message]");
        replaceSub("COOKIE_DAY_COUNT", itemForSection.maximumCookieDuration);
        replaceSub("COOKIE_REFRESH_STATUS", itemForSection.isCookieRefreshed ? "[cky_iab_vendors_cookie_refreshed_message]" : "[cky_iab_vendors_cookie_not_refreshed_message]");
        deviceStorageOverviewText = getFinalSub();
      }

      replaceKey("cky_iab_vendors_item_device_overview", deviceStorageOverviewText);
      let showMoreButtonText = "";

      if (!itemForSection.isGoogleVendor) {
        showMoreButtonText = vendorItemTableButton.replace("[BUTTON_TEXT]", "[cky_showmore_text]");
      }

      replaceKey("cky_iab_vendors_item_table_button", showMoreButtonText);
      replaceKey("ITEM_ID", `ckyIABVendorSection${section.id}Item${itemForSection.id}`);
      replaceKey("ITEM_NAME", itemForSection.name);
      itemsHTML = `${itemsHTML} ${getFinalText()}`;
    });
    replaceParent("cky_iab_vendors_item", itemsHTML);
    replaceParent("cky_iab_vendors_section_toggle", section.toggle ? vendorsSectionToggle : "");
    replaceParent("{{sectionKey}}", section.key, 2);
...
function _ckySetIABTabSelection() {
  ...
  _ckySetIABSectionSpecificItems(ref._pnfTabs, "ckyIABPNFSection", [1, 4], ".cky-accordion-iab-item");

  _ckySetIABSectionSpecificItems(ref._thirdPartyLists, "ckyIABVendorSection", [1, 2], ".cky-accordion-iab-item");

  _ckySetIABVendorShowMore();
}

function _ckyGetIABUIChoices() {
  const [purposeList, purposeLegitimateInterestList] = _ckyIABGetChoicesForSection("ckyIABPNFSection", ref._pnfTabs[0].sublist, 1);

  const [specialFeaturesList] = _ckyIABGetChoicesForSection("ckyIABPNFSection", ref._pnfTabs[3].sublist, 4);

  const [vendorConsentList, vendorLegtimateInterestList] = _ckyIABGetChoicesForSection("ckyIABVendorSection", ref._thirdPartyLists[0].sublist, 1);

  const [adtechVendorConsentList] = _ckyIABGetChoicesForSection("ckyIABVendorSection", ref._thirdPartyLists[1].sublist, 2);

  return [vendorLegtimateInterestList, vendorConsentList, purposeList, purposeLegitimateInterestList, specialFeaturesList, adtechVendorConsentList];
}
...
function _ckyIABGetChoicesForSection(key, list, sectionID) {
  ...
  list.forEach(item => {
    const consentToggleElement = _ckyFindElement(`#${key}${sectionID}Item${item.id}ToggleConsent`);

    if (consentToggleElement && consentToggleElement.checked) consentedItems.push(item.id);

    const legitimateToggleElement = _ckyFindElement(`#${key}${sectionID}Item${item.id}ToggleLegitimate`);

    if (legitimateToggleElement && legitimateToggleElement.checked) legitimateItems.push(item.id);
  });
...
function _ckySetIABTabSelectListeners() {
  ...
  tabNames.forEach(tab => {
    ...
    _ckyAttachListener(tabSelector, () => {
      if (_ckyHasClass(tabSelector, "cky-iab-nav-item-active", false)) return;

      _ckyClassToggle(tabSelector, "cky-iab-nav-item-active", false);

      _ckyClassToggle(`#ckyIABSection${tab}`, "cky-hide-ad-settings", false);

      tabNames.filter(tabName => tabName !== tab).forEach(filteredName => {
        _ckyClassRemove(`#ckyIABTab${filteredName}`, "cky-iab-nav-item-active", false);

        _ckyClassAdd(`#ckyIABSection${filteredName}`, "cky-hide-ad-settings", false);
      });
    });
  });
}
...
function _ckysetIABNoticeButton() {
  _ckyAttachListener("#ckyIABNoticeButton", () => {
    if (ref._ckyStore._bannerConfig.bannerType !== "classic") _ckyBannerControl(false);
...
function _ckySetIABPreferenceButton() {
  _ckyAttachListener("#ckyIABPreferenceButton", () => _ckyOpenIABThirdpartyList(1));
}

function _ckySIABGACMPreferenceButton() {
  _ckyAttachListener("#ckyIABGACMPreferenceButton", () => _ckyOpenIABThirdpartyList(2));
}

function _ckyOpenIABThirdpartyList(key) {
  _ckyFindElement("#ckyIABTabVendor").click();

  if (!key) return ref._thirdPartyLists.forEach(item => _ckyClassRemove(`#ckyIABVendorSection${item.id}`, "cky-accordion-active", false));
  if (_ckyHasClass(`#ckyIABVendorSection${key}`, "cky-accordion-active", false)) return;

  _ckyFindElement(`#ckyIABVendorSection${key} > .cky-accordion-iab-item`).click();
}

function _ckySetIABSectionSpecificItems(list, key, allowedItems, toggleClass) {
  _ckySetIABSectionAllToggle(list, key, allowedItems);

  _ckySetIABSectionClearToggle(list, key, allowedItems);

  _ckySetIABOpenCloseListeners(list, key, toggleClass);
}
...
function _ckySetIABSectionAllToggle(list, key, allowedItems) {
  ...
  list.forEach(section => {
    ...
    _ckySetCheckBoxInfo(currentElement, ariaLabel, {
    ...
    _ckyAttachListener(`${sectionKey}Toggle`, () => {
      section.sublist.forEach(item => {
        ...
        ["ToggleConsent", "ToggleLegitimate"].forEach(fieldName => _ckySetToggleElementChecked(`${itemKey}${fieldName}`, currentElement.checked));
      });
    });
  });
}
...
function _ckySetIABSectionClearToggle(list, key, allowedItems) {
  list.forEach(section => {
    ...
    section.sublist.forEach(item => {
      const itemKey = `${sectionKey}Item${item.id}`;
      ["ToggleConsent", "ToggleLegitimate"].forEach(fieldName => _ckySetToggleListener(`${itemKey}${fieldName}`, `${sectionKey}Toggle`));
    });
  });
}
...
function _ckySetIABVendorShowMore() {
  ...
  const vendorItemStorageDisclosure = shortCodeFinder("cky_iab_vendors_item_storage_disclosure");
  const vendorItemTableLoader = shortCodeFinder("cky_iab_vendors_item_loader");
  const vendorItemTableLoadError = shortCodeFinder("cky_iab_vendors_item_loaderror");

  const ckyAuditTable = ref._ckyStore._commonShortCodes.find(code => code.key === "cky_audit_table");
  ...
  ref._thirdPartyLists.forEach(tab => {
    tab.sublist.forEach(item => {
      ...
      _ckyAttachListener(selector, _ckyVendorShowMoreListener(item.deviceDisclosureURL, tab.id, item.id, vendorItemTableLoader, vendorItemTableLoadError, vendorItemStorageDisclosure, ckyAuditTable.content.container));
    });
  });
}

function _ckyVendorShowMoreListener(url, tabID, itemID, vendorItemTableLoader, vendorItemTableLoadError, vendorItemStorageDisclosure, vendorItemStorageTableContent) {
  const key = `ckyIABVendorSection${tabID}Item${itemID}`;
  return async ({
    target
  }) => {
    _ckySetContentReplacingElement(target, vendorItemTableLoader, key, "cky_iab_common_loading");
    ...
    try {
      ...
      if (!parsedResponse || !parsedResponse.disclosures || !parsedResponse.disclosures.length) throw new Error(`Invalid disclosures`);
      const disclosedItems = parsedResponse.disclosures.map(disclosure => ({
        name: disclosure.identifier,
        type: disclosure.type,
        duration: disclosure.maxAgeSeconds ? Math.round(disclosure.maxAgeSeconds / (60 * 60 * 24)) : 0,
        domain: disclosure.domains || [],
        purpose: (disclosure.purposes || []).map(id => ref._tcModal.gvl.purposes[id].name)
      }));

      const [replaceKey, getFinalText] = _ckyReplaceKeysInText(vendorItemStorageDisclosure);

      const contentToInsert = disclosedItems.map(disclosure => {
        const tableItemContent = ["name", "type", "duration", "domain", "purpose"].map(header => `<li><div>${_ckyGetTranslation(header === "purpose" ? `cky_iab_common_purposes` : `cky_iab_vendors_device_storage_disclosure_table_${header}`)}</div><div>${header === "purpose" ? `<ul class="cky-purposes-list">${disclosure.purpose.map(purpose => `<li>${purpose}</li>`).join("")}</ul>` : header === "domain" ? disclosure.domain.join(",") : disclosure[header]}</div></li>`).join("");
        return vendorItemStorageTableContent.replace("[CONTENT]", tableItemContent);
      });
      replaceKey("CONTENT", contentToInsert.join(""));
      replaceKey("cky_iab_vendors_device_storage_disclosure_title", null, 2);

      _ckySetContentReplacingElement(loaderElement, getFinalText(), key);
    } catch (error) {
      _ckySetContentReplacingElement(loaderElement, vendorItemTableLoadError, key, "cky_iab_common_load_error");
    }
  };
}

function _ckySetContentReplacingElement(element, template, key, message = null) {
  let content = template.replace("[ITEM_ID]", key);
  if (message) content = content.replace(`[${message}]`, _ckyGetTranslation(message));
  element.insertAdjacentHTML("afterEnd", content);
  element.remove();
}

function _ckySetIABOpenCloseListeners(list, keyPreffix, keySuffix) {
  list.forEach(item => {
    const itemSelector = `#${keyPreffix}${item.id} > ${keySuffix}`;

    _ckyAttachListener(itemSelector, ({
      target: {
        id
      }
    }) => {
      const accordionButtonSelector = `#${keyPreffix}${item.id} .cky-accordion-btn`;
      if (id.startsWith(`${keyPreffix}${item.id}Toggle`) || !_ckyClassToggle(itemSelector, "cky-accordion-active")) return _ckyToggleAriaExpandStatus(accordionButtonSelector, "false");
    ...
    if (item.sublist) {
      ...
      _ckyAttachListener(`#${keyPreffix}${item.id} > .cky-accordion-body`, ({
        target
      }) => {
        const sectionOfAction = item.sublist.find(item => {
          const parentElement = document.querySelector(`#${keyPreffixSub}${item.id} > .cky-child-accordion-item`);
          return parentElement.contains(target);
        });
        if (!sectionOfAction) return;
        const itemID = `${keyPreffixSub}${sectionOfAction.id}`;
        const accordionButtonSelectorSub = `#${itemID} .cky-child-accordion-btn`;
        if (target.id.startsWith(`${itemID}Toggle`) || !_ckyClassToggle(`#${itemID} > .cky-child-accordion-item`, "cky-accordion-active")) return _ckyToggleAriaExpandStatus(accordionButtonSelectorSub, "false");

        _ckyToggleAriaExpandStatus(accordionButtonSelectorSub, "true");

        _ckyCleanNodesWithClasses(item.sublist, keyPreffixSub, sectionOfAction.id, ".cky-child-accordion-btn");
      });
    }
  });
}

function _ckyCreateVendorConsentText(items, subtitle, vendorItemDataRetentionMessage, vendorItemPurposes) {
  let purposesForConsentText = "";

  if (items.length > 0) {
    const purposesList = items.map(purpose => `<li>${purpose.name} ${purpose.dataRetention > 0 ? `(${vendorItemDataRetentionMessage.replace("[DATA_RENTENTION_DAYS]", purpose.dataRetention)})` : ""}</li>`).join("");
    purposesForConsentText = vendorItemPurposes.replace("[HEADER]", `[cky_iab_common_purposes] ([${subtitle}])`).replace("[CONTENT]", purposesList);
  }
...
function _ckyCreateVendorOptionalText(items, optionalMessage) {
  ...
  if (items.length > 0) {
    const optionalItemList = items.map(item => `<li>${item.name}</li>`).join("");
    optionalItemText = optionalMessage.replace("[CONTENT]", optionalItemList);
  }

  return optionalItemText;
}

function _ckySetToggleListener(key, parentToggle) {
  const toggleElement = _ckyFindElement(key);
  ...
  _ckySetCheckBoxInfo(toggleElement, ariaLabel, {
    checked: toggleElement.checked,
    addListeners: true
  }, togglerIABSwitch.styles);

  _ckyAttachListener(key, event => {
...
function _ckyGetFocusableElements(element) {
  ...
  const focussableElements = Array.from(wrapperElement.querySelectorAll('a:not([disabled]), button:not([disabled]), [tabindex]:not([disabled]):not([tabindex="-1"])')).filter(element => element.style.display !== "none");
...
function _ckyLoopFocus() {
  ...
  const [firstElementPopup, lastElementPopup] = _ckyGetFocusableElements(activeLaw === "ccpa" ? "optout-popup" : "detail");
...
function _ckyCloseButtonAction() {
  ...
  if (ref._ckyStore._bannerDisplayState !== "revisit") {
    ...
    const nextFocusElement = document.querySelector(`[data-cky-tag="${activeLaw === "gdpr" ? "settings-button" : "donotsell-button"}"]`);
...
function _ckySettingsAction() {
  if (ref._ckyStore._bannerConfig.bannerType === "classic") return _ckyPreferenceCenterControl(!_ckyIsPreferenceOpen());
...
function _ckyRevisitAction() {
  ...
  if (ref._ckyStore._bannerConfig.bannerType === "classic") _ckyBannerControl();
...
function _ckyRegisterListeners() {
  ["=accept-button", "=detail-accept-button"].map(key => _ckyAttachListener(key, _ckyBannerAction("all")));
  ["=reject-button", "=detail-reject-button"].map(key => _ckyAttachListener(key, _ckyBannerAction("reject")));
  ["=detail-save-button", "=detail-category-preview-save-button", "=optout-confirm-button"].map(key => _ckyAttachListener(key, _ckyBannerAction()));
  ["=settings-button", "=donotsell-button"].map(key => _ckyAttachListener(key, _ckySettingsAction));
  ["=optout-cancel-button", "=detail-close", "=optout-close"].map(key => _ckyAttachListener(key, _ckyCloseButtonAction));
...
function _ckyAttachCategoryListeners() {
  ...
  const categoryNames = ref._ckyStore._categories.map(({
    slug
  }) => slug);
  ...
  categoryNames.map(category => {
    ...
    _ckyAttachListener(selector, ({
      target: {
        id
      }
    }) => {
      if (id === `ckySwitch${category}` || !_ckyClassToggle(selector, "cky-accordion-active", false)) return _ckyToggleAriaExpandStatus(accordionButtonSelector, "false");

      _ckyToggleAriaExpandStatus(accordionButtonSelector, "true");

      categoryNames.filter(categoryName => categoryName !== category).map(filteredName => {
...
function _ckySetCategorySelections(addListeners = true) {
  ...
  const toggleDataCode = dataShortCodes.find(code => code.key === "cky_category_toggle_label");

  for (const category of ref._ckyStore._categories) {
    const cookieValue = ref._ckyGetFromStore(category.slug);

    const checked = cookieValue === "yes" || !cookieValue && category.defaultConsent[activeLaw];
    const formattedLabel = toggleDataCode.content.container.replace(`[cky_preference_{{category_slug}}_title]`, _ckyGetTranslation(`cky_preference_${category.slug}_title`));
    [`ckyCategoryDirect`, `ckySwitch`].map(key => _ckySetCheckBoxInfo(_ckyFindElement(`#${key}${category.slug}`), formattedLabel, {
      checked,
...
function _ckySetCheckBoxInfo(boxElem, formattedLabel, {
  checked,
  disabled,
  addListeners
}, {
...
function _ckySetCheckBoxAriaLabel(boxElem, isChecked, formattedLabel, isCCPA = false) {
  ...
  const labelText = formattedLabel.replace(/{{status}}/g, keyName).replace(`[${textCode}]`, _ckyGetTranslation(textCode));
...
function _ckyAttachReadMore() {
  ...
  const readMoreCode = ref._ckyStore._bannerConfig.dataShortCodes.find(code => code.key === "cky_readmore");

  const content = readMoreCode.processedHTML;
  let readMoreElement = null;
  if (activeLaw === "gdpr") readMoreElement = document.querySelector('[data-cky-tag="iab-description"] p:last-child');else readMoreElement = document.querySelector('[data-cky-tag="description"] p:last-child');
  readMoreElement && readMoreElement.insertAdjacentHTML("beforeend", `&nbsp;${content.replaceAll("[cky_readmore_text]", _ckyGetTranslation("cky_readmore_text")).replace(`href="#"`, `href="${_ckyGetTranslation("cky_readmore_privacyLink")}"`)}`);
}
...
function _ckySetShowMoreLess() {
  ...
  const showCode = dataShortCodes.find(code => code.key === "cky_show_desc");
  const hideCode = dataShortCodes.find(code => code.key === "cky_hide_desc");
  if (!showCode || !hideCode) return;
  const hideButtonContent = `${hideCode.content.button.replaceAll("[cky_showless_text]", _ckyGetTranslation("cky_showless_text"))}`;
  const showButtonContent = `${showCode.content.button.replaceAll("[cky_showmore_text]", _ckyGetTranslation("cky_showmore_text"))}`;
  ...
  for (let index = 0; index < innerElements.length; index++) {
    ...
    if (`${strippedContent}${element.outerHTML}`.length > contentLimit) element.insertAdjacentHTML("beforeend", `...&nbsp;${showButtonContent}`);
...
ref._ckySetPlaceHolder = function (uniqueID = "") {
  const {
    status,
    styles
  } = ref._ckyStore._bannerConfig.placeHolder;
  if (!status) return;
  const placeHolderQuery = `${uniqueID ? `#${uniqueID} ` : ""}[data-cky-tag="placeholder-title"]`;
  ...
  Array.from(placeHolders).forEach(placeHolder => {
    ...
    placeHolder.addEventListener("click", () => {
      if (ref._ckyStore._bannerDisplayState === "revisit") _ckyRevisitAction();
    });
...
function _ckyIsPreferenceOpen() {
  ...
  if (bannerType === "classic") return _ckyHasClass("=notice", "cky-consent-bar-expand");
...
function _ckyRemoveAndReInitializeBanner() {
  ...
  ["=notice", "=detail", "=optout-popup", ".cky-overlay", "=revisit-consent"].map((key, index) => _ckyRemoveElement(key, index < 3));
  ...
  if (ref._ckyStore._bannerDisplayState === "banner") return _ckyBannerControl();
...
function _ckyWatchBannerElement() {
  document.querySelector("body").addEventListener("click", event => {
    ...
    if (event.target.matches ? event.target.matches(selector) : event.target.msMatchesSelector(selector)) _ckyRevisitAction();
  });
}
...
async function _ckyGeoIP() {
  try {
    const geoIPResponse = await _ckyRequest("https://phpstack-273836-3239094.cloudwaysapps.com/api/v1/ip");
    ...
    ref._ckyStore._ruleData._regionName = userInEU ? "EU" : continent;
  } catch (err) {
    ref._ckyStore._ruleData._geoIPFailed = true;
    console.error(err);
  }
}
...
async function _ckyLogCookies() {
  try {
    const logData = JSON.stringify(ref._ckyStore._categories.map(({
      slug
    }) => ({
      name: slug,
      ...
      status: ref._ckyStore._bannerConfig.activeLaw === "ccpa" ? "yes" : ref._ckyGetFromStore("consent") || "no"
    }]));
    const data = new FormData();
    data.append("log", logData);
    data.append("key", "3a8196c3494857295a4ab43b");
    ...
    data.append("cookie_list_version", "13");
    data.append("tcf_data", _ckyGetTCEncodedString());
    data.append("gacm_data", ref._addtlConsent);
    navigator.sendBeacon("https://phpstack-273836-2510610.cloudwaysapps.com/api/v1/log", data);
  } catch (err) {
    console.error(err);
  }
}
...
function _ckyLanguageObserver(mutations) {
  for (const mutation of mutations) {
    ...
    let siteLanguage = _ckyFindApplicableLanguage(document.documentElement.lang);
...
function _ckyFindApplicableLanguage(currentLang) {
  if (ref._ckyStore._language._localeMap[currentLang]) return ref._ckyStore._language._localeMap[currentLang];
...
async function _ckyGetLanguageJSON(url) {
  ...
  if (!languageFile || typeof languageFile !== "object" || Object.keys(languageFile).length === 0) throw new Error(`Invalid response`);
  return languageFile;
}
...
async function _ckyFetchLanguage(language) {
  ...
  if (languageDictionary && languageDictionary.setAuditTableContent && languageDictionary.setLanguageContent) return;
  let languageFile = {};
  if ((!languageDictionary || !languageDictionary.setLanguageContent) && ref._ckyStore._bannerConfig.languageMap && ref._ckyStore._bannerConfig.languageMap[language]) languageFile = await _ckyGetLanguageJSON(`https://scriptstaging.cookieyes.com/client_data/3a8196c3494857295a4ab43b/translations/${ref._ckyStore._bannerConfig.languageMap[language]}.json`);
  let languageFileAuditTable = {};
  if (!languageDictionary || !languageDictionary.setAuditTableContent) languageFileAuditTable = await _ckyGetLanguageJSON(`https://scriptstaging.cookieyes.com/client_data/3a8196c3494857295a4ab43b/audit-table/${ref._ckyStore._language._supportedMap[language]}.json`);

  ref._ckyStore._language._store.set(language, { ...languageFile,
...
async function _ckySetupTranslation() {
  try {
    const siteLanguage = _ckyFindApplicableLanguage(document.documentElement.lang);
...
const {
  ...
  GVL,
  Segment
} = __webpack_require__(/*! ./iab-tcf-core */ "./iab-tcf-core/index.js");

const {
  CmpApi
} = __webpack_require__(/*! @iabtcf/cmpapi */ "./node_modules/@iabtcf/cmpapi/lib/cjs/index.js");
...
async function _ckyInitializeGVL() {
  ...
  if (window.iabConfig && window.iabConfig.allowedVendors) gvl.narrowVendorsTo(window.iabConfig.allowedVendors);
  if (window.iabConfig && window.iabConfig.allowedGoogleVendors) gvl.narrowGoogleVendorsTo(window.iabConfig.allowedGoogleVendors);
  return gvl;
}
...
function _ckyIABStatusUpdate(uiStatus = false, skip = false) {
  const {
    activeLaw
  } = ref._ckyStore._bannerConfig;

  ref._cmpAPI.update(activeLaw === "gdpr" ? uiStatus && skip ? "" : _ckyGetTCEncodedString() : null, uiStatus);
}
...
function _ckySetIABConsentState(choice = "all") {
  if (choice === "all") {
    ...
    if (choice === "custom" && activeLaw === "gdpr") {
      const [vendorLegtimateInterestList, vendorConsentList, purposeList, purposeLegitimateInterestList, specialFeaturesList, adtechVendorConsentList] = _ckyGetIABUIChoices();

      ref._tcModal.vendorConsents.set(vendorConsentList);

      ref._tcModal.vendorLegitimateInterests.set(vendorLegtimateInterestList);

      ref._tcModal.purposeLegitimateInterests.set(purposeLegitimateInterestList);
...
function _ckyGetIABVendorsForUI() {
  ...
  response.sectionChecked = response.consent.allowed.length >= vendorsWithPurpose.length && response.legitimateInterest.allowed.length >= vendorsWithLegIntPurposes.length;
  return response;
}
...
function _ckyGetGoogleVendorsForUI() {
  ...
  if (ref._addtlConsent) ref._addtlConsent.split("~")[1].split(".").forEach(vendorId => allowedGoogleVendors[vendorId] = true);
  ...
  response.sectionChecked = response.consent.allowed.length === _ckyGetIntMapLength(ref._tcModal.gvl.googleVendors);
  return response;
}
...
function _ckyGetIABPurposeForUI() {
  ...
  ref._tcModal.purposeLegitimateInterests.forEach((hasConsent, vendorId) => {
    if (hasConsent) response.legitimateInterest.allowed.push(vendorId);else response.legitimateInterest.rejected.push(vendorId);
  });

  response.sectionChecked = response.consent.allowed.length === _ckyGetIntMapLength(ref._tcModal.gvl.purposes);
  return response;
}
...
function _ckyGetIABFeaturesForUI() {
  ...
  response.sectionChecked = response.consent.allowed.length === _ckyGetIntMapLength(ref._tcModal.gvl.specialFeatures);
  return response;
}
...
function _ckyPopulatePNFTabs() {
  ref._pnfTabs = [{
    ...
    id: 1,
    toggle: true,
    sublist: Object.values(ref._tcModal.gvl.purposes).map(_ckyGetIABPurposeItem(1, true))
  }, {
    key: "special_purposes",
    id: 2,
    toggle: false,
    sublist: Object.values(ref._tcModal.gvl.specialPurposes).map(_ckyGetIABPurposeItem(2, false, false))
  }, {
    key: "features",
    id: 3,
    toggle: false,
    sublist: Object.values(ref._tcModal.gvl.features).map(_ckyGetIABPurposeItem(3, false, false))
  }, {
    key: "special_features",
    id: 4,
    toggle: true,
    sublist: Object.values(ref._tcModal.gvl.specialFeatures).map(_ckyGetIABPurposeItem(4, true, false))
  }];
}
...
function _ckyPopulateThirdPartyLists() {
  ref._thirdPartyLists = [{
    ...
    sublist: Object.values(ref._tcModal.gvl.vendors).map(vendor => ({
      ...
      dataCategories: _ckyGetIABVendorData(ref._tcModal.gvl.dataCategories, vendor.dataDeclaration || []),
      purposesForConsent: _ckyGetIABVendorData(ref._tcModal.gvl.purposes, vendor.purposes, vendor.dataRetention),
      purposesForLegitimateInterest: _ckyGetIABVendorData(ref._tcModal.gvl.purposes, vendor.legIntPurposes, vendor.dataRetention),
      specialPurposes: _ckyGetIABVendorData(ref._tcModal.gvl.specialPurposes, vendor.specialPurposes),
      features: _ckyGetIABVendorData(ref._tcModal.gvl.features, vendor.features),
      specialFeatures: _ckyGetIABVendorData(ref._tcModal.gvl.specialFeatures, vendor.specialFeatures),
  ...
  ref._thirdPartyLists.push({
    ...
    id: 2,
    toggle: true,
    sublist: Object.values(ref._tcModal.gvl.googleVendors).map(vendor => ({
      id: vendor.id,
      name: vendor.name,
...
function _ckyGetIABPurposeItem(type, hasConsentToggle, hasLegitimateInterest = null) {
  return ({
    id,
    name,
    description,
    ...
    hasItemLegitimateConsent = hasItemLegitimateConsent === null ? ![1, 3, 4, 5, 6].includes(id) : hasItemLegitimateConsent;
    let seekerCount = 0;
    if (type === 1) seekerCount = _ckyGetIntMapLength(ref._tcModal.gvl.getVendorsWithConsentPurpose(id)) + _ckyGetIntMapLength(ref._tcModal.gvl.getVendorsWithLegIntPurpose(id));else if (type === 2) seekerCount = _ckyGetIntMapLength(ref._tcModal.gvl.getVendorsWithSpecialPurpose(id));else if (type === 3) seekerCount = _ckyGetIntMapLength(ref._tcModal.gvl.getVendorsWithFeature(id));else seekerCount = _ckyGetIntMapLength(ref._tcModal.gvl.getVendorsWithSpecialFeature(id));
    return {
      id,
      name,
...
function _ckyGetIABVendorData(list, filter, dataRetention) {
  return Object.values(list).filter(purpose => filter.includes(purpose.id)).map(purpose => {
    const response = {
      name: purpose.name
    };
...
function _ckyAttachBannerToUI() {
  ...
  let parsedHTML = _ckyPrepareHTML(iabEnabled ? _ckyPopulateIABOptions(html) : html);
  ...
  if (bannerType === "classic") _ckyToggleAriaExpandStatus("=settings-button", "false");
...
async function _ckySetupBanner(bannerID) {
  const response = await _ckyRequest(`https://scriptstaging.cookieyes.com/client_data/3a8196c3494857295a4ab43b/config/${bannerID}.json`);
  ...
  _ckyIABStatusUpdate(!actionState, true);
...
if (document.readyState === "complete") _ckyWindowLoadHandler();else window.addEventListener("load", _ckyWindowLoadHandler);
})();
